...
var App = /*#__PURE__*/function () {
  function App() {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "getResourses", /*#__PURE__*/function () {
      var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default.a.mark(function _callee(url) {
        var res;
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(App, [{
    ...
    value: function updateCartItemAjax(id, qty) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_5___default.a.ajax({
        ...
        url: '/cart/update.js',
        data: {
          updates: _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()({}, "".concat(id), qty)
        },
        dataType: 'json',
        async: false,
    ...
    value: function initAddProductAction() {
      ...
      productForm.onsubmit = function (e) {
        ...
        var ajaxCartContainer = document.querySelector('.ajax-cart__container');
        ...
        document.querySelectorAll('.ajax-cart__product').forEach(function (product) {
...
/***/ "./src/scripts/templates/jquery.plugins.js":
/*!*************************************************!*\
  !*** ./src/scripts/templates/jquery.plugins.js ***!
  \*************************************************/
/*! no exports provided */
...
window.ResponsiveHelper = function (a) {
  ...
  function c() {
    var t = i.width();
    t !== n && (n = t, a.each(e, function (n, e) {
      a.each(e.data, function (a, n) {
        n.currentActive && !d(n.range[0], n.range[1]) && (n.currentActive = !1, "function" == typeof n.disableCallback && n.disableCallback());
      }), a.each(e.data, function (a, n) {
        !n.currentActive && d(n.range[0], n.range[1]) && (n.currentActive = !0, "function" == typeof n.enableCallback && n.enableCallback());
      });
    }));
  }
  function d(a, e) {
    var i,
      ...
      d,
      o = "";
    return a > 0 && (o += "(min-width: " + a + "px)"), e < 1 / 0 && (o += (o ? " and " : "") + "(max-width: " + e + "px)"), i = o, c = a, d = e, window.matchMedia && t ? matchMedia(i).matches : window.styleMedia ? styleMedia.matchMedium(i) : window.media ? media.matchMedium(i) : n >= c && n <= d;
  }
  return window.matchMedia && (window.Window && window.matchMedia === Window.prototype.matchMedia ? t = !0 : window.matchMedia.toString().indexOf("native") > -1 && (t = !0)), i.bind("load resize orientationchange", c), {
    addRange: function addRange(i) {
      var t = {
        data: {}
      };
      a.each(i, function (a, n) {
        var e, i;
        t.data[a] = {
          range: (e = a, i = e.split(".."), [parseInt(i[0], 10) || -1 / 0, parseInt(i[1], 10) || 1 / 0].sort(function (a, n) {
            return a - n;
          })),
          enableCallback: n.on,
...
!function (t) {
  ...
  t.fn.mobileNav = function (e) {
    ...
    return this.each(function () {
      var s = jQuery(this),
        a = s.data("MobileNav");
      "object" == _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(e) || void 0 === e ? s.data("MobileNav", new i(t.extend({
        container: this
...
$.fn.slideAccordion = function (opt) {
  ...
  return this.each(function () {
    ...
    if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(opt) === 'object' || typeof opt === 'undefined') {
...
!function (e) {
  ...
  t.prototype = {
    ...
    attachEvents: function attachEvents() {
      ...
      this.eventHandler = function (e) {
        ...
        t.hideSlide();
      })), t.outsideClickHandler = function (o) {
    ...
    showSlide: function showSlide() {
      var t = this;
      t.options.addClassBeforeAnimation && t.holder.addClass(t.options.activeClass), t.slider.removeClass(s), e(document).on("click touchstart", t.outsideClickHandler), t.makeCallback("animStart", !0), n[t.options.effect].show({
        box: t.slider,
    ...
    hideSlide: function hideSlide() {
      var t = this;
      t.options.addClassBeforeAnimation && t.holder.removeClass(t.options.activeClass), e(document).off("click touchstart", t.outsideClickHandler), t.makeCallback("animStart", !1), n[t.options.effect].hide({
        box: t.slider,
        speed: t.options.animSpeed,
        complete: function complete() {
  ...
  var o,
    i,
    s = "js-slide-hidden";
  o = e('<style type="text/css">')[0], i = "." + s, i += "{position:absolute !important;left:-9999px !important;top:-9999px !important;display:block !important}", o.styleSheet ? o.styleSheet.cssText = i : o.appendChild(document.createTextNode(i)), e("head").append(o);
  var n = {
    slide: {
  ...
  e.fn.openClose = function (o) {
    var i = Array.prototype.slice.call(arguments),
      s = i[0];
    return this.each(function () {
      var n = jQuery(this),
        a = n.data("OpenClose");
      "object" == _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(o) || void 0 === o ? n.data("OpenClose", new t(e.extend({
        holder: this
      }, o))) : "string" == typeof s && a && "function" == typeof a[s] && (i.shift(), a[s].apply(a, i));
    });
  };
}(jQuery);
